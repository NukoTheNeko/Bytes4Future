export declare function get_continuations(results: any, continuation_type: string, limit: number | null, request: (additional_params: Record<string, string>) => Promise<any>, parse: (data: any) => any[], _ctoken_path?: string, reloadable?: boolean): Promise<{
    items: any[];
    continuation: string;
}>;
...
export declare function get_continuation_contents<T extends any = any>(continuation: any, parse: (data: any) => T[]): T[];
